...
### The goal of the project is to provide a demo of a custom game engine using SDL2 and modular C++23 that introduces a dynamic fake-3D tile system, simulation based character development, and a custom path finding algorhythm.
## Todo:
- [ ] Get rid of the nested loops (put the whole tile system in a single vector)
- [ ] Add dynamic shading
- [ ] Add animated dwarf
...
- [ ] Add more tasks (resource gathering, building)
- [ ] Add some dwarf personality traits
- [ ] Add UI
- [ ] Add first dialog window (being recognised by another dwarf clan for example?)
- [ ] Add trading feature
